...
<header class="simple-header" id="cp-header">
    <a class="simple-brand" href="/" aria-label="<?= htmlspecialchars($logoAria, ENT_QUOTES, 'UTF-8') ?>">
        ...
        <span class="pc-brand-copy">
            ...
            <span><?= htmlspecialchars($isRu ? '������ ��� ������, ��������, ����, ����� � ready-made assets ��� affiliate-������' : 'a journal about traffic, creatives, farms, cases and ready-made assets for affiliate teams', ENT_QUOTES, 'UTF-8') ?></span>
        </span>
    </a>

    <div class="simple-header-center">
        <form class="simple-header-search" method="get" action="/blog/">
            <input type="text" name="q" data-search-input placeholder="<?= htmlspecialchars($isRu ? '�����: Facebook farm, TikTok creatives, cloaking, tracker setup' : 'Search: Facebook farm, TikTok creatives, cloaking, tracker setup', ENT_QUOTES, 'UTF-8') ?>" autocomplete="off" autocapitalize="off" autocorrect="off" spellcheck="false">
            <button type="submit"><?= htmlspecialchars($isRu ? '�����' : 'Search', ENT_QUOTES, 'UTF-8') ?></button>
        </form>
    </div>

    <div class="simple-header-right">
        <a class="simple-header-action" href="/solutions/downloads/"><?= htmlspecialchars($isRu ? '������� assets' : 'Get assets', ENT_QUOTES, 'UTF-8') ?></a>
...
(function () {
    ...
    var placeholders = <?= $isRu ? "json_encode(['�����: Facebook farm, TikTok creatives, cloaking, tracker setup','�����: ����������, ������� ���������, BM risk, payment flow','�����: nutra, sweepstakes, crypto funnel, tracker cleanup'], JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES)" : "json_encode(['Search: Facebook farm, TikTok creatives, cloaking, tracker setup','Search: anti-detect, account warmup, BM risk, payment flow','Search: nutra, sweepstakes, crypto funnel, tracker cleanup'], JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES)" ?>;
    if (header) {
