...
if (!function_exists('examples_cluster_label')) {
    function examples_cluster_label(string $clusterCode, string $lang = 'en'): string
    {
        ...
        $safeMap = [
            'meta-ads' => 'Meta Ads',
            'tiktok-funnels' => 'TikTok Funnels',
            'telegram-retention' => 'Telegram',
            'ai-creatives' => 'AI Creatives',
            'tracking-loss' => 'Tracking Loss',
            'market-demand' => 'Market Demand',
            'creative-shelf' => 'Creative Shelf Life',
            'source-volatility' => 'Source Volatility',
            'offer-selection' => 'Offer Selection',
            'team-handoff' => 'Handoff',
            'team-structure' => 'Team Structure',
            'compliance-buffers' => 'Compliance Buffers',
            'moderation-pressure' => 'Moderation',
            'telegram-distribution' => 'Telegram Distribution',
            'farm-economics' => 'Farm Economics',
            'geo-source-map' => 'Source Map',
            'attribution-decay' => 'Attribution',
            'team-rhythm' => 'Team Rhythm',
            'facebook-farm' => 'Facebook Farm',
            'cloaking-routing' => 'Routing',
            'tracker-postback' => 'Tracker / Postback',
            'anti-detect' => 'Anti-Detect',
            'creative-testing' => 'Creative Testing',
            'payments-recovery' => 'Payments Recovery',
            'launch-qa' => 'Launch QA',
            'bm-trust' => 'BM / Trust',
            'handoff-templates' => 'Handoff',
            'failover-routing' => 'Failover Routing',
            'creative-review' => 'Creative Review',
            'offer-screening' => 'Offer Screening',
            'junior-setup' => 'Junior Setup',
            'checkout-continuity' => 'Checkout',
            'tracking-hygiene' => 'Tracking Hygiene',
            'rollback-planning' => 'Rollback',
            'bundle-migration' => 'Bundle Migration',
            'alerts-routine' => 'Alerts',
            'meta-policy' => 'Meta Policy',
            'telegram-rules' => 'Telegram Rules',
            'tiktok-restrictions' => 'TikTok Restrictions',
            'cis-regulation' => 'CIS Regulation',
            'privacy-attribution' => 'Privacy / Attribution',
            'payments-compliance' => 'Payments / Compliance',
            'account-trust' => 'Account Trust',
            'moderation-volatility' => 'Moderation',
            'measurement-loss' => 'Measurement Loss',
            'telegram-enforcement' => 'Telegram Enforcement',
            'response-plan' => 'Response Plan',
            'politics' => 'Politics',
            'business-analysis' => 'Business Analysis',
            'exchange-analysis' => 'Exchange Analysis',
            'crypto-signals' => 'Crypto',
            'russia-business' => 'Russia Business',
            'russia-law' => 'Russia Law',
            'sanctions-payments' => 'Sanctions / Payments',
            'central-bank' => 'Central Bank',
            'ad-budget-shifts' => 'Ad Budget Shifts',
            'messenger-economics' => 'Messenger Economics',
            'political-cycles' => 'Political Cycles',
            'agency-folklore' => 'Agency Folklore',
            'farm-drama' => 'Farm Drama',
            'creative-burnout' => 'Creative Burnout',
            'tracker-chaos' => 'Tracker Chaos',
            'team-memes' => 'Team Memes',
            'moderation-tragicomedy' => 'Moderation',
            'night-dashboard' => 'Night Dashboard',
            'assistant-buyer' => 'Assistant / Buyer',
            'launch-rituals' => 'Launch Rituals',
            'office-theatre' => 'Office Theatre',
            'bm-quest' => 'BM Quest',
            'telegram-tribe' => 'Telegram Tribe',
            'burnout-comedy' => 'Burnout Comedy',
            'spreadsheet-cult' => 'Spreadsheet Cult',
            'anti-detect-myth' => 'Anti-Detect Myth',
            'offer-screening-satire' => 'Offer Screening',
            'voice-note-folklore' => 'Voice Note Folklore',
            'post-banwave-meeting' => 'Post-Banwave Meeting',
        ];
        if (isset($safeMap[$code])) {
            return $safeMap[$code];
        }
        if ($lang === 'ru') {
            $ruMap = [
            ...
            $ruMap += [
                'meta-ads' => 'Meta Ads',
                'tiktok-funnels' => 'TikTok',
                'telegram-retention' => 'Telegram',
                'ai-creatives' => 'AI-РєСЂРµР°С‚РёРІС‹',
                'tracking-loss' => 'РўСЂРµРєРёРЅРі',
                'market-demand' => 'РЎРїСЂРѕСЃ',
                'creative-shelf' => 'РљСЂРµР°С‚РёРІС‹',
                'source-volatility' => 'РСЃС‚РѕС‡РЅРёРєРё',
                'offer-selection' => 'РћС„С„РµСЂС‹',
                'team-handoff' => 'Handoff',
                'team-structure' => 'РљРѕРјР°РЅРґР°',
                'compliance-buffers' => 'РљРѕРјРїР»Р°РµРЅСЃ',
                'moderation-pressure' => 'Moderation',
                'telegram-distribution' => 'Telegram',
                'farm-economics' => 'Р¤Р°СЂРј',
                'geo-source-map' => 'РљР°СЂС‚Р° СЂС‹РЅРєР°',
                'attribution-decay' => 'РђС‚СЂРёР±СѓС†РёСЏ',
                'team-rhythm' => 'РћРїРµСЂР°С†РёРѕРЅРєР°',
                'facebook-farm' => 'Р¤Р°СЂРј',
                'cloaking-routing' => 'Routing',
                'tracker-postback' => 'РўСЂРµРєРёРЅРі',
                'anti-detect' => 'Anti-detect',
                'creative-testing' => 'РљСЂРµР°С‚РёРІС‹',
                'payments-recovery' => 'РџР»Р°С‚РµР¶РєРё',
                'launch-qa' => 'Launch QA',
                'bm-trust' => 'BM / Trust',
                'handoff-templates' => 'Handoff',
                'failover-routing' => 'Failover',
                'creative-review' => 'Creative Review',
                'offer-screening' => 'РЎРєСЂРёРЅРёРЅРі РѕС„С„РµСЂРѕРІ',
                'junior-setup' => 'Setup',
                'checkout-continuity' => 'Checkout',
                'tracking-hygiene' => 'РўСЂРµРєРёРЅРі',
                'rollback-planning' => 'Rollback',
                'bundle-migration' => 'РЎРІСЏР·РєРё',
                'alerts-routine' => 'РђР»РµСЂС‚С‹',
                'meta-policy' => 'Meta',
                'telegram-rules' => 'Telegram',
                'tiktok-restrictions' => 'TikTok',
                'cis-regulation' => 'Р РµРіСѓР»СЏС‚РѕСЂРёРєР°',
                'privacy-attribution' => 'Privacy',
                'payments-compliance' => 'РџР»Р°С‚РµР¶Рё',
                'account-trust' => 'Trust',
                'moderation-volatility' => 'Moderation',
                'measurement-loss' => 'РР·РјРµСЂРµРЅРёРµ',
                'telegram-enforcement' => 'Telegram',
                'response-plan' => 'РћРїРµСЂР°С†РёРё',
                'politics' => 'РџРѕР»РёС‚РёРєР°',
                'business-analysis' => 'Р‘РёР·РЅРµСЃ',
                'exchange-analysis' => 'Р‘РёСЂР¶Рё',
                'crypto-signals' => 'РљСЂРёРїС‚Р°',
                'russia-business' => 'Р РѕСЃСЃРёСЏ / Р‘РёР·РЅРµСЃ',
                'russia-law' => 'Р РѕСЃСЃРёСЏ / Р—Р°РєРѕРЅС‹',
                'sanctions-payments' => 'РЎР°РЅРєС†РёРё',
                'central-bank' => 'Р¦РµРЅС‚СЂРѕР±Р°РЅРєРё',
                'ad-budget-shifts' => 'Р РµРєР»Р°РјРЅС‹Р№ СЂС‹РЅРѕРє',
                'messenger-economics' => 'РњРµСЃСЃРµРЅРґР¶РµСЂС‹',
                'political-cycles' => 'РџРѕР»РёС‚РёРєР°',
                'agency-folklore' => 'Р¤РѕР»СЊРєР»РѕСЂ',
                'farm-drama' => 'Р¤Р°СЂРј',
                'creative-burnout' => 'РљСЂРµР°С‚РёРІС‹',
                'tracker-chaos' => 'РўСЂРµРєРµСЂС‹',
                'team-memes' => 'РњРµРјС‹',
                'moderation-tragicomedy' => 'Moderation',
                'night-dashboard' => 'РќРѕС‡РЅР°СЏ СЃРјРµРЅР°',
                'assistant-buyer' => 'РљРѕРјР°РЅРґР°',
                'launch-rituals' => 'Р РёС‚СѓР°Р»С‹',
                'office-theatre' => 'РћС„РёСЃ',
                'bm-quest' => 'BM',
                'telegram-tribe' => 'Telegram',
                'burnout-comedy' => 'Р’С‹РіРѕСЂР°РЅРёРµ',
                'spreadsheet-cult' => 'РњРµС‚СЂРёРєРё',
                'anti-detect-myth' => 'Anti-detect',
                'offer-screening-satire' => 'РћС„С„РµСЂС‹',
                'voice-note-folklore' => 'Р“РѕР»РѕСЃРѕРІС‹Рµ',
                'post-banwave-meeting' => 'Banwave',
            ];
            if (isset($ruMap[$code])) {
                return $ruMap[$code];
            }
