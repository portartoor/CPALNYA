...
portal_section_build($FRMWRK, $ModelPage, 'signals', [
    ...
    'hero_description_ru' => "Раздел для тех, кто следит не только за цифрами открута, но и за тем, как меняется сама сцена: policy-повороты платформ, регуляторные движения в СНГ, новые ограничения, payment-сдвиги и рыночные сигналы, которые первыми бьют по affiliate-операционке.\n\nЗдесь мы собираем новости не ради шума, а ради ориентира. Что действительно меняется, кого заденет первым, какие гео и источники начинают шататься и где команде нужно перестраиваться до того, как это станет всеобщей болью.\n\nЭто не новостная лента, а редакционный радар для баеров, операторов, фармеров и тех, кто принимает решения под давлением платформенных правил.",
