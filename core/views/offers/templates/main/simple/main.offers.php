...
.ofr-page{max-width:1240px;padding:24px 16px 46px;color:var(--shell-text);font-family:"Sora",system-ui,sans-serif}
.ofr-hero,.ofr-card,.ofr-detail,.ofr-story,.ofr-section,.ofr-phases,.ofr-int,.ofr-check,.ofr-order,.ofr-related-offers a{border-color:var(--shell-border)!important;background:var(--shell-panel)!important;backdrop-filter:blur(14px);box-shadow:var(--shell-shadow)}
.ofr-hero{position:relative;overflow:hidden;border-radius:30px;padding:34px}
.ofr-hero:after{content:"";position:absolute;right:-50px;top:-60px;width:240px;height:240px;border-radius:999px;background:radial-gradient(circle,rgba(122,180,255,.28),rgba(122,180,255,0));pointer-events:none}
.ofr-hero h1,.ofr-card h3,.ofr-detail h2,.ofr-order h3{font-family:"Space Grotesk","Sora",sans-serif;color:var(--shell-text)}
.ofr-hero h1{font-size:clamp(2.6rem,4vw,4.4rem);line-height:.94;max-width:12ch}
.ofr-hero p,.ofr-card p,.ofr-sub,.ofr-lead p,.ofr-story p,.ofr-section p,.ofr-phase p,.ofr-int p,.ofr-int ul,.ofr-check ul,.ofr-order p{color:var(--shell-muted)!important}
.ofr-btn,.ofr-back{border-color:var(--shell-border)!important;background:rgba(255,255,255,.05)!important;color:var(--shell-text)!important;box-shadow:none!important}
.ofr-btn.primary,.ofr-order button{background:linear-gradient(135deg,#7ab4ff,#2ce0c7)!important;color:#07111f!important;border-color:rgba(122,180,255,.34)!important}
.ofr-chip{border-color:rgba(122,180,255,.28)!important;background:rgba(122,180,255,.08)!important;color:var(--shell-accent)!important}
.ofr-grid,.ofr-sections,.ofr-related-offers{gap:16px}
.ofr-card,.ofr-detail,.ofr-order{border-radius:24px}
.ofr-order input,.ofr-order textarea,.ofr-table,.ofr-table th,.ofr-table td,.ofr-phase{border-color:var(--shell-border)!important;background:rgba(255,255,255,.03)!important;color:inherit}
</style>
