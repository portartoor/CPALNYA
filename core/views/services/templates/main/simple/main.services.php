...
.services-simple-hero{border:1px solid #d6e0ed;border-radius:18px;padding:20px;background:linear-gradient(145deg,#f9fcff,#eff6ff)}
...
.services-simple-alert{margin-top:12px;border:1px solid #edcc8a;background:#fff5e0;color:#664a17;border-radius:10px;padding:10px 12px}
.services-simple-groups{margin-top:12px;display:flex;flex-wrap:wrap;gap:8px}
.services-simple-groups a{display:inline-flex;align-items:center;gap:6px;border:1px solid #c7d7ec;border-radius:999px;padding:7px 11px;text-decoration:none;color:#2f4d71;background:#fff;font-size:13px}
.services-simple-groups a.active{background:#0d63d6;color:#fff;border-color:#0d63d6}
.services-simple-groups small{opacity:.8}
.services-simple-selected{margin-top:14px;border:1px solid #d7e2f0;border-radius:14px;background:#ffffff;padding:18px}
...
.services-simple-selected-content .svc-block{margin:0 0 12px;padding:12px;border:1px solid #d6e2f1;border-radius:12px;background:#f9fcff}
...
.services-simple-back{display:inline-flex;align-items:center;gap:6px;margin-bottom:10px;padding:6px 10px;border:1px solid #bfd5ee;border-radius:999px;color:#0d5db7;text-decoration:none;font-size:13px;font-weight:600}
...
.services-simple-card{background:#fff;border:1px solid #d6e0ed;border-radius:14px;padding:14px;display:flex;flex-direction:column;gap:8px}
...
.services-simple-link{margin-top:auto;align-self:flex-start;display:inline-flex;align-items:center;gap:6px;padding:6px 10px;border:1px solid #bfd5ee;border-radius:999px;color:#0d5db7;text-decoration:none;font-size:13px;font-weight:600;white-space:nowrap}
.services-simple-link:hover{background:#f1f7ff}
.services-simple-empty{margin-top:14px;border:1px solid #d6e0ed;border-radius:12px;padding:12px;color:#4f6684;background:#fff}
.services-inline-contact{margin-top:14px;border:1px solid #d8e4f2;border-radius:14px;padding:14px;background:linear-gradient(145deg,#f8fbff,#eef5ff)}
...
.services-inline-contact .contact-alert{margin:0 0 10px;padding:10px;border:1px solid;border-radius:8px;font-size:14px}
...
.services-inline-contact input,.services-inline-contact textarea{width:100%;box-sizing:border-box;padding:10px 12px;border-radius:10px;border:1px solid #c8d7ea;background:#fbfdff;color:#163250;font:inherit}
.services-inline-contact textarea{grid-column:1 / -1;min-height:120px;resize:vertical}
.services-inline-contact button{grid-column:1 / -1;border:0;border-radius:10px;padding:11px 14px;font-weight:700;cursor:pointer;background:linear-gradient(135deg,#0d63d6,#0e9a91);color:#fff}
