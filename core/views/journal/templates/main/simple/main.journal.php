    ...
    <div class="jrnl-shell">
            ...
            <article class="jrnl-detail">
                ...
                <div class="jrnl-detail-body">
                    ...
                    <div class="jrnl-actions">
                        <a class="jrnl-btn" href="<?= htmlspecialchars($buildPageUrl($currentCluster), ENT_QUOTES, 'UTF-8') ?>"><?= htmlspecialchars($t('РќР°Р·Р°Рґ РІ journal', 'Back to journal'), ENT_QUOTES, 'UTF-8') ?></a>
                    </div>
        ...
        <?php else: ?>
            ...
            <?php if (!empty($clusters)): ?>
                <div class="jrnl-tags" aria-label="<?= htmlspecialchars($t('РўРµРјС‹ РІС‹РїСѓСЃРєР°', 'Issue topics'), ENT_QUOTES, 'UTF-8') ?>">
