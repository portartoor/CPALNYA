    ...
    function journal_issue_defaults(string $lang = 'ru'): array
    {
        ...
        if ($lang === 'ru') {
            return [
                ...
                'hero_description' => 'Редакционный фронт для материалов по трафику, креативам, фарму, модерации, трекингу и работе команды. Здесь журнал выглядит как выпуск, а не как поток случайных постов.',
