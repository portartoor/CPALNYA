    ...
    function journal_issue_defaults(string $lang = 'ru'): array
    {
        ...
        if ($lang === 'ru') {
            return [
                ...
                'issue_title' => 'Выпуск: backstage affiliate-операций',
                'issue_subtitle' => 'Закулисье арбитражных команд: источники трафика, медиабаинг, фарм аккаунтов, креативные связки, трекеры, модерация и операционные playbooks для CPA-команд, которые выстраивают системную affiliate-операционку, а не живут от запуска к запуску.',
                'hero_title' => 'Журнал про операционку affiliate-команд',
                'hero_description' => 'Журнал про арбитраж трафика, affiliate-операции, медиабаинг, креативы, фарм аккаунтов, трекинг и модерацию. Здесь выходят редакционные разборы, кейсы и market-intelligence материалы для CPA-команд, собранные как цельный выпуск, а не как лента случайных публикаций.',
